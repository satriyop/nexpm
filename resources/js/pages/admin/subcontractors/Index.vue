...
<template>
    ...
    <div class="space-y-6 p-6">
        <div class="flex items-center justify-between">
            ...
            <Button @click="open = true"><Plus class="mr-1.5 h-4 w-4" />Add Subcontractor</Button>
        </div>

        <Card>
            <CardHeader><CardTitle>All Subcontractors ({{ subcontractors.total }})</CardTitle></CardHeader>
            ...
            <form class="space-y-4" @submit.prevent="submit">
                <div class="grid grid-cols-2 gap-3">
                    <div class="grid gap-1.5">
                        ...
                        <Input v-model="form.name" placeholder="PT Mitra Jaya…" autofocus />
