    ...
    <div class="space-y-6 p-6">
        <div>
            ...
            <p class="mt-1 text-sm text-muted-foreground">
                Global configuration that applies across all projects and
                reports.
            </p>
        </div>
        ...
        <form class="max-w-lg space-y-5" @submit.prevent="submit">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription
                        >Settings applied to all generated PDF documents (SSR,
                        BAST).</CardDescription
                    >
                </CardHeader>
                <CardContent class="space-y-4">
                    <div class="grid gap-1.5">
                        ...
                        <p class="text-xs text-muted-foreground">
                            Printed at the bottom of every SSR and BAST PDF.
                            Leave blank to omit.
                        </p>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription
                        >Where to send system notifications.</CardDescription
                    >
                </CardHeader>
                <CardContent class="space-y-4">
                    <div class="grid gap-1.5">
                        ...
                        />
                        <p class="text-xs text-muted-foreground">
                            CC'd whenever a report is generated. Leave blank to
                            disable.
                        </p>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription
                        >Days before an activity is flagged as overdue on the
                ...
                <CardContent class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-1.5">
                            ...
                            <Input
                                v-model.number="form.survey_sla_days"
                                type="number"
                                min="1"
                                max="365"
                            />
                            <InputError
                                :message="form.errors.survey_sla_days"
                            />
                        </div>
                        <div class="grid gap-1.5">
                            <Label>Construction SLA (days)</Label>
                            <Input
                                v-model.number="form.construction_sla_days"
                                type="number"
                                min="1"
                                max="365"
                            />
                            <InputError
                                :message="form.errors.construction_sla_days"
                            />
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="grid gap-1.5">
                            ...
                            <Input
                                v-model.number="form.slow_days"
                                type="number"
                                min="1"
                                max="365"
                            />
                            <p class="text-xs text-muted-foreground">
                                Amber "Slow" badge appears after this many days
                                without progress.
                            </p>
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <Input
                                v-model.number="form.stalled_days"
                                type="number"
                                min="1"
                                max="365"
                            />
                            <p class="text-xs text-muted-foreground">
                                Red "Stalled" badge appears after this many days
                                without progress.
                            </p>
