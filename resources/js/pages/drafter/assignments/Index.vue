...
import { Eye, LockKeyhole, Search, X } from 'lucide-vue-next';
...
function getAssignment(assignments: any, type: string): any | null {
    ...
    return (
        Array.from(assignments).find((a: any) => a?.activity_type === type) ||
        null
    );
}
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        >
                            <td
                                class="px-4 py-3 font-mono text-xs font-semibold text-primary"
                            >
                                {{ site.site_code }}
                            </td>
                            <td class="px-4 py-3">
