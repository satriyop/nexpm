...
class BastReportExportService
{
    ...
    private const EVCS_CHECKPOINT_MAP = [
        ...
        'measurement_voltage_rs' => ['KWH,AC Panel, Cable', 'B', 14],
        'measurement_voltage_rt' => ['KWH,AC Panel, Cable', 'F', 14],
        'measurement_voltage_st' => ['KWH,AC Panel, Cable', 'B', 16],
        'measurement_frequency' => ['KWH,AC Panel, Cable', 'F', 16],
        'measurement_voltage_ng' => ['KWH,AC Panel, Cable', 'B', 18],
        'measurement_grounding_ac' => ['KWH,AC Panel, Cable', 'F', 18],
    ...
    private const BSS_CHECKPOINT_MAP = [
        ...
        'ac_panel_wiring' => ['KWH,AC Panel, Cable', 'B', 12],
        'ac_phase_marking' => ['KWH,AC Panel, Cable', 'F', 12],
        'measurement_voltage_rn' => ['KWH,AC Panel, Cable', 'B', 14],
        'measurement_voltage_rg' => ['KWH,AC Panel, Cable', 'F', 14],
        'measurement_frequency' => ['KWH,AC Panel, Cable', 'B', 16],
        'measurement_voltage_ng' => ['KWH,AC Panel, Cable', 'F', 16],
        'measurement_grounding_ac' => ['KWH,AC Panel, Cable', 'B', 18],
        'cable_spec' => ['KWH,AC Panel, Cable', 'B', 23],
        'cable_routing_1' => ['KWH,AC Panel, Cable', 'F', 23],
        'cable_routing_2' => ['KWH,AC Panel, Cable', 'B', 24],
        'cable_routing_3' => ['KWH,AC Panel, Cable', 'F', 24],
