...
class BastReportExportService
{
    ...
    private function fillCoverSheet(Spreadsheet $spreadsheet, ?\App\Models\AssignmentBastData $bastData, Assignment $assignment): void
    {
    ...
    private function fillMeasurements(Spreadsheet $spreadsheet, ?\App\Models\AssignmentBastData $bastData, bool $isBss): void
    {
        if ($bastData === null) {
            return;
        }
    ...
    private function embedPhotos(Spreadsheet $spreadsheet, ?\App\Models\AssignmentBastData $bastData, bool $isBss): void
    {
        if ($bastData === null) {
            return;
        }
