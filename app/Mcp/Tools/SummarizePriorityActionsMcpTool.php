...
#[Name('summarize_priority_actions')]
#[Description('Top priority actions: blocker assignments + report-ready items.')]
#[IsReadOnly]
class SummarizePriorityActionsMcpTool extends Tool
{
