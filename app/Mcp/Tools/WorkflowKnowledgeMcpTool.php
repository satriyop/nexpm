...
#[Name('workflow_knowledge')]
#[Description('Workflow knowledge reference: status transitions, verifiable statuses, admin-locked statuses.')]
#[IsReadOnly]
class WorkflowKnowledgeMcpTool extends Tool
{
