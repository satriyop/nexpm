    ...
    public static function all(): array
    {
        return [
            ...
            [
                ...
                'type' => 'text', 'required' => false, 'max' => 255,
                'section' => 'general', 'reportable' => true, 'report_order' => 60,
                'reports' => ['ssr'],
            ],
            // ── Technical ─────────────────────────────────────────────────────
            [
            ...
            [
                ...
                'type' => 'text', 'required' => false, 'max' => 255,
                'section' => 'technical', 'reportable' => true, 'report_order' => 90,
                'reports' => ['ssr'],
            ],
            [
                'key' => 'additional_info', 'label' => 'Additional Info',
                'type' => 'textarea', 'required' => false,
                'section' => 'technical', 'reportable' => false, 'report_order' => 100,
                'reports' => [],
            ],
            // ── Photos ────────────────────────────────────────────────────────
            [
                ...
                'section' => 'photos', 'reportable' => false, 'report_order' => 200,
                'reports' => [],
            ],
            [
                'key' => 'photo_parking_evcs', 'label' => 'Foto Lahan Parkir EVCS / Lokasi BSS',
                'type' => 'image', 'required' => false, 'max' => 10240,
                'section' => 'photos', 'reportable' => false, 'report_order' => 210,
                'reports' => [],
            ],
            [
                'key' => 'photo_other_angle', 'label' => 'Foto Lahan Sudut Pandang Lain',
                'type' => 'image', 'required' => false, 'max' => 10240,
                'section' => 'photos', 'reportable' => false, 'report_order' => 220,
                'reports' => [],
            ],
            [
                'key' => 'photo_pln_network', 'label' => 'Foto Jaringan PLN Terdekat',
                'type' => 'image', 'required' => false, 'max' => 10240,
                'section' => 'photos', 'reportable' => false, 'report_order' => 230,
                'reports' => [],
            ],
            [
                'key' => 'photo_satellite_gmaps', 'label' => 'Foto Satelit GMaps',
                'type' => 'image', 'required' => false, 'max' => 10240,
                'section' => 'photos', 'reportable' => false, 'report_order' => 240,
                'reports' => [],
            ],
            // ── Documents ─────────────────────────────────────────────────────
            [
                ...
                'section' => 'documents', 'reportable' => false, 'report_order' => 300,
                'reports' => [],
            ],
            [
                'key' => 'file_ba_survey', 'label' => 'BA Survey',
                'type' => 'file', 'required' => false, 'max' => 20480,
                'section' => 'documents', 'reportable' => false, 'report_order' => 310,
                'reports' => [],
            ],
        ];
    }
